...
-keep class com.chat.im.WKIM {*;}
-keep class com.chat.im.message.type.WKMsgContentType { *; }
-keep class com.chat.im.message.type.WKSendMsgResult { *; }
-keep class com.chat.im.message.type.WKConnectStatus { *; }
-keep class com.chat.im.message.type.WKConnectReason { *; }
