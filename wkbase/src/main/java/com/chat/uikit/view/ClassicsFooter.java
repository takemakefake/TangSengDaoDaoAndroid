 ...
 * 2021/8/3 17:59
 */
public class ClassicsFooter extends ClassicsAbstract<com.scwang.smart.refresh.footer.ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs) {
        ...
        View.inflate(context, R.layout.wk_chat_list_footer, this);
