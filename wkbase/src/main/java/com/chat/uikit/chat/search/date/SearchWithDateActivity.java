...
import com.chat.app.databinding.ActSearchMsgWithDateLayoutBinding;
 ...
 * 通过日期搜索聊天记录
 */
public class SearchWithDateActivity extends WKBaseActivity<ActSearchMsgWithDateLayoutBinding> {
