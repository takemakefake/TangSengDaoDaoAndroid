package com.chat.base.views.pinnedsectionitemdecoration;
...
import com.chat.base.views.pinnedsectionitemdecoration.callback.OnHeaderClickListener;
import com.chat.base.views.pinnedsectionitemdecoration.callback.OnItemTouchListener;
import com.chat.base.views.pinnedsectionitemdecoration.utils.DividerHelper;
...
public class PinnedHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private final OnHeaderClickListener mHeaderClickListener;

    private final boolean mEnableDivider;
    private  int outsideMarginTop;
    private final boolean mDisableHeaderClick;

    private final int mDividerId;

    private final int[] mClickIds;
    ...
    private final int mPinnedHeaderType;
    ...
    public void setOutsideMarginTop(int outsideMarginTop) {
        this.outsideMarginTop = outsideMarginTop;
    }

    private PinnedHeaderItemDecoration(Builder builder) {
        mEnableDivider = builder.enableDivider;
        outsideMarginTop = builder.outsideMarginTop;
    ...
    @Override
    public void getItemOffsets(@NonNull final Rect outRect, @NonNull final View view, @NonNull final RecyclerView parent, @NonNull RecyclerView.State state) {
...
//            final View belowView = parent.findChildViewUnder(c.getWidth() / 2, headEnd + 1);
            ...
            if (belowViewAdapterPosition > mFirstVisiblePosition && isPinnedHeader(parent, belowView)) {
                ...
                mPinnedHeaderOffset = belowView.getTop() - (mRecyclerViewPaddingTop + mPinnedHeaderView.getHeight() + mHeaderTopMargin + outsideMarginTop);
    ...
    public static class Builder {
        ...
        public Builder setOutsideMarginTop(int top) {
