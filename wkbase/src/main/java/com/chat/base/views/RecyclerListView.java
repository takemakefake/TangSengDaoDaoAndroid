...
//        }
    ...
    private class FastScroll extends View {
        ...
        public FastScroll(Context context) {
            ...
            scrollX = AndroidUtilities.isRTL ? AndroidUtilities.dp(10) : AndroidUtilities.dp(117);
            updateColors();
        }

        private void updateColors() {
            int inactive = ContextCompat.getColor(getContext(), R.color.layoutColor);
            int active = ContextCompat.getColor(getContext(), R.color.layoutColor);
            paint.setColor(inactive);
            letterPaint.setColor(ContextCompat.getColor(getContext(), R.color.layoutColor));
        ...
        public boolean onTouchEvent(MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (AndroidUtilities.isRTL && x > AndroidUtilities.dp(25) || !AndroidUtilities.isRTL && x < AndroidUtilities.dp(107) || lastY < currentY || lastY > currentY + AndroidUtilities.dp(30)) {
                        return false;
                    }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if ((pressed || bubbleProgress != 0)) {
                ...
                if (AndroidUtilities.isRTL && (radii[0] != raduisTop || radii[6] != raduisBottom) || !AndroidUtilities.isRTL && (radii[2] != raduisTop || radii[4] != raduisBottom)) {
                    if (AndroidUtilities.isRTL) {
                    ...
                    path.reset();
                    rect.set(AndroidUtilities.isRTL ? AndroidUtilities.dp(10) : 0, 0, AndroidUtilities.dp(AndroidUtilities.isRTL ? 98 : 88), AndroidUtilities.dp(88));
...
//        selectorDrawable = AndroidUtilities.getSelectorDrawable(false);
        init(context);
    }
        ...
        if (sectionsType == 1) {
            if (sectionsAdapter != null && !headers.isEmpty()) {
                for (int a = 0; a < headers.size(); a++) {
                    ...
                    canvas.translate(AndroidUtilities.isRTL ? getWidth() - header.getWidth() : 0, top);
            ...
            if (sectionsAdapter != null && pinnedHeader != null && pinnedHeader.getAlpha() != 0) {
                ...
                canvas.translate(AndroidUtilities.isRTL ? getWidth() - pinnedHeader.getWidth() : 0, top);
