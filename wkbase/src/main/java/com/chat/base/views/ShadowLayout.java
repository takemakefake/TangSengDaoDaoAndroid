...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, getResources().getDimension(R.dimen.dimen_0));
            //默认扩散区域宽度
            mShadowLimit = attr.getDimension(R.styleable.ShadowLayout_hl_shadowLimit, getResources().getDimension(R.dimen.dimen_5));
