...
public class NumberPicker extends LinearLayout {
    ...
    private void init() {
        ...
        mSelectionDivider.setColor(Theme.colorAccount);
        ...
        mInputText.setTextColor(ContextCompat.getColor(getContext(), R.color.colorDark));
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (scrollSelectorValue != null && (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE)) {
                if (SELECTOR_WHEEL_ITEM_COUNT > 3) {
                    ...
                    p = interpolator.getInterpolation(AndroidUtilities.clamp(p, 1f, 0));
