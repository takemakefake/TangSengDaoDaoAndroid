...
//            textPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        private void drawInternal(Canvas canvas) {
            ...
            updateX(countWidth);
            rectF.set(x, countTop, x + countWidth + AndroidUtilities.dp(11), countTop + AndroidUtilities.dp(20));
            if (circlePaint != null && drawBackground) {
                ...
                if (addServiceGradient) {
                    canvas.drawRoundRect(rectF, 11.5f * AndroidUtilities.density, 11.5f * AndroidUtilities.density, AndroidUtilities.chat_actionBackgroundGradientDarkenPaint);
                }
            }
            if (countLayout != null) {
                canvas.save();
...
//                    this.textColor = textColor;
                textPaint.setColor(ContextCompat.getColor(WKBaseApplication.getInstance().getContext(), textColor));
//                }
//                if (circlePaint != null && this.circleColor != circleColor) {
//                    this.circleColor = circleColor;
                circlePaint.setColor(ContextCompat.getColor(WKBaseApplication.getInstance().getContext(), circleColor));
//                }
            }
